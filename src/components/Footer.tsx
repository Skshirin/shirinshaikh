...
export default function Footer() {
  return (
    <footer className="relative border-t border-border py-12">
      <div className="mx-auto max-w-7xl px-8 sm:px-12 lg:px-24">
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          {/* Left */}
          <div className="flex items-center gap-4">
            <span className="font-display text-2xl tracking-wider text-text-primary">SS</span>
            <span className="h-4 w-[1px] bg-border" />
            <span className="font-mono text-xs text-text-dim">
              Designed & Built by Shirin Shaikh
            </span>
          </div>
          ...
          <div className="font-mono text-[10px] uppercase tracking-[0.2em] text-text-dim">
            &copy; {new Date().getFullYear()} Shirin Shaikh
          </div>
        </div>
        ...
        <div className="mt-8 flex justify-center">
          ...
          >
            <svg
              className="h-4 w-4 text-text-dim transition-colors group-hover:text-accent"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth={1.5}
            ...
            <span className="font-mono text-[9px] uppercase tracking-[0.3em] text-text-dim transition-colors group-hover:text-accent">
              Back to top
            </span>
          </motion.a>
        </div>
